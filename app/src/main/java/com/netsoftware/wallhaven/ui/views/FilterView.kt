...
import com.netsoftware.wallhaven.data.models.User.Companion.CATEGORY_ANIME
import com.netsoftware.wallhaven.data.models.User.Companion.CATEGORY_GENERAL
import com.netsoftware.wallhaven.data.models.User.Companion.CATEGORY_PEOPLE
import com.netsoftware.wallhaven.data.models.User.Companion.PURITY_SFW
import com.netsoftware.wallhaven.data.models.User.Companion.PURITY_SKETCHY
import com.netsoftware.wallhaven.databinding.PartFilterBinding
...
class FilterView(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    private fun defaultSetup() {
        setCategories(defaultConfig.getCategoriesMap())
        setPurities(defaultConfig.getPurityMap())
        setResolution(defaultConfig)
        setRatio(defaultConfig.getRatioList())
        setColor(defaultConfig.colors)
    }
...
//                    }
    ...
    private fun setResolution(config: SearchConfig) {
        if (config.resolution_at_least.isNotEmpty()) binding.resolutionSwitch.setSelectedTab(0)
        else if (config.resolutions.isNotEmpty()) binding.resolutionSwitch.setSelectedTab(1)
        binding.resolutionValueBtn.text =
