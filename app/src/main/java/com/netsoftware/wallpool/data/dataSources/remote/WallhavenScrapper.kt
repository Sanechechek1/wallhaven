...
import com.netsoftware.wallpool.utility.extensions.UrlHandler
import com.netsoftware.wallpool.utility.extensions.convert
...
object WallhavenScrapper {
    private val base = HttpUrl.parse("https://alpha.wallpool.cc")!!
